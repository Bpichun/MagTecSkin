...
# -*- coding: utf-8 -*-
"""
Created on Tue May 13 13:24:49 2025
...
def createScene(rootNode):
                ...
                rootNode.addObject(
                    ...
                    name="light1",
                    color="0.8 0.8 0.8",
                    position=[0, -Const.SensorLength-20, 3],
                )
                rootNode.addObject(
                    "PositionalLight",
                    name="light2",
                    color="0.8 0.8 0.8",
                    position=[0, -Const.SensorLength-20, 0],
                )
                ...
                # boxTips = []
                # for i in range(5):
                #     roi = completeMesh.addObject('BoxROI',
                #                                   name=f'Tip_{i}',
                #                                   box=Const.MagnetBoxCoords[i],
                #                                   drawBoxes=True,
