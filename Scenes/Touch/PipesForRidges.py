...
FileName = '../Geometries/Sensor.step'
...
np.save("PointsOnSurface.npy", PointsOnSurfaceCoordinates)
np.savetxt("PointsOnSurface.txt", PointsOnSurfaceCoordinates)

np.savetxt("Mask.txt", Mask.astype(int), fmt="%i")